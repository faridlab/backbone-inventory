//! Lot DTOs (Data Transfer Objects)
//!
...
/// Request DTO for creating a new Lot
///
...
/// Request DTO for full update of a Lot
///
...
/// Request DTO for partial update of a Lot
///
...
/// Paginated list response for Lot entities
///
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct LotListResponseDto {
    /// List of items
    pub items: Vec<LotResponseDto>,
...
impl LotListResponseDto {
    /// Create a new list response from items and pagination info
    pub fn new(items: Vec<LotResponseDto>, total: u64, page: u32, per_page: u32) -> Self {
...
impl From<Lot> for LotResponseDto {
    fn from(entity: Lot) -> Self {
        Self {
            id: entity.id,
            name: entity.name,
...
impl From<Lot> for LotSummaryDto {
    fn from(entity: Lot) -> Self {
...
impl From<CreateLotDto> for Lot {
    fn from(dto: CreateLotDto) -> Self {
        Self {
            id: Uuid::new_v4(),
            name: dto.name,
...
impl backbone_core::FromCreateDto<CreateLotDto> for Lot {
    fn from_create_dto(dto: CreateLotDto) -> backbone_core::ServiceResult<Self> {
        Ok(Lot::from(dto))
    }
}

impl backbone_core::ApplyUpdateDto<UpdateLotDto> for Lot {
    fn apply_update(mut self, dto: UpdateLotDto) -> backbone_core::ServiceResult<Self> {
        self.name = dto.name;
...
// <<< CUSTOM DTOs
// Add custom DTOs specific to Lot here.
