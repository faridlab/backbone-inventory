//! Bin DTOs (Data Transfer Objects)
//!
...
/// Request DTO for creating a new Bin
///
...
/// Request DTO for full update of a Bin
///
...
/// Request DTO for partial update of a Bin
///
...
/// Paginated list response for Bin entities
///
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct BinListResponseDto {
    /// List of items
    pub items: Vec<BinResponseDto>,
...
impl BinListResponseDto {
    /// Create a new list response from items and pagination info
    pub fn new(items: Vec<BinResponseDto>, total: u64, page: u32, per_page: u32) -> Self {
...
impl From<Bin> for BinSummaryDto {
    fn from(entity: Bin) -> Self {
...
impl From<CreateBinDto> for Bin {
...
impl From<&Bin> for BinResponseDto {
    fn from(entity: &Bin) -> Self {
        Self {
            ...
            reserved_qty: entity.reserved_qty.clone(),
...
impl backbone_core::FromCreateDto<CreateBinDto> for Bin {
    fn from_create_dto(dto: CreateBinDto) -> backbone_core::ServiceResult<Self> {
        Ok(Bin::from(dto))
    }
}
