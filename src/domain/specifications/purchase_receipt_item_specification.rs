//! Specifications for PurchaseReceiptItem aggregate
//!
...
// Each predicate implements `Specification<PurchaseReceiptItem>` and can be combined
...
//
// pub struct ActivePurchaseReceiptItemSpec;
// impl Specification<PurchaseReceiptItem> for ActivePurchaseReceiptItemSpec {
//     fn is_satisfied_by(&self, e: &PurchaseReceiptItem) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
