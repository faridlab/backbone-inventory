//! Specifications for Transfer aggregate
//!
...
// Each predicate implements `Specification<Transfer>` and can be combined
...
//
// pub struct ActiveTransferSpec;
// impl Specification<Transfer> for ActiveTransferSpec {
//     fn is_satisfied_by(&self, e: &Transfer) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
