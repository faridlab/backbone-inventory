//! Specifications for OperationType aggregate
//!
...
// Each predicate implements `Specification<OperationType>` and can be combined
...
//
// pub struct ActiveOperationTypeSpec;
// impl Specification<OperationType> for ActiveOperationTypeSpec {
//     fn is_satisfied_by(&self, e: &OperationType) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
