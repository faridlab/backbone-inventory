//! Specifications for StockReconciliation aggregate
//!
...
// Each predicate implements `Specification<StockReconciliation>` and can be combined
...
//
// pub struct ActiveStockReconciliationSpec;
// impl Specification<StockReconciliation> for ActiveStockReconciliationSpec {
//     fn is_satisfied_by(&self, e: &StockReconciliation) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
