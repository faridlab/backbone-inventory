//! Specifications for DeliveryNote aggregate
//!
...
// Each predicate implements `Specification<DeliveryNote>` and can be combined
...
//
// pub struct ActiveDeliveryNoteSpec;
// impl Specification<DeliveryNote> for ActiveDeliveryNoteSpec {
//     fn is_satisfied_by(&self, e: &DeliveryNote) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
