//! Specifications for PickingBatch aggregate
//!
...
// Each predicate implements `Specification<PickingBatch>` and can be combined
...
//
// pub struct ActivePickingBatchSpec;
// impl Specification<PickingBatch> for ActivePickingBatchSpec {
//     fn is_satisfied_by(&self, e: &PickingBatch) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
