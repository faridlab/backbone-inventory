//! Specifications for DeliveryNoteItem aggregate
//!
...
// Each predicate implements `Specification<DeliveryNoteItem>` and can be combined
...
//
// pub struct ActiveDeliveryNoteItemSpec;
// impl Specification<DeliveryNoteItem> for ActiveDeliveryNoteItemSpec {
//     fn is_satisfied_by(&self, e: &DeliveryNoteItem) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
