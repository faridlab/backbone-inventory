//! Specifications for StockBatch aggregate
//!
...
// Each predicate implements `Specification<StockBatch>` and can be combined
...
//
// pub struct ActiveStockBatchSpec;
// impl Specification<StockBatch> for ActiveStockBatchSpec {
//     fn is_satisfied_by(&self, e: &StockBatch) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
