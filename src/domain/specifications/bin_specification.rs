//! Specifications for Bin aggregate
//!
...
// Each predicate implements `Specification<Bin>` and can be combined
...
//
// pub struct ActiveBinSpec;
// impl Specification<Bin> for ActiveBinSpec {
//     fn is_satisfied_by(&self, e: &Bin) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
