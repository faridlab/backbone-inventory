//! Specifications for Quant aggregate
//!
...
// Each predicate implements `Specification<Quant>` and can be combined
...
//
// pub struct ActiveQuantSpec;
// impl Specification<Quant> for ActiveQuantSpec {
//     fn is_satisfied_by(&self, e: &Quant) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
