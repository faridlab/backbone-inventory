//! Specifications for Location aggregate
//!
...
// Each predicate implements `Specification<Location>` and can be combined
...
//
// pub struct ActiveLocationSpec;
// impl Specification<Location> for ActiveLocationSpec {
//     fn is_satisfied_by(&self, e: &Location) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
