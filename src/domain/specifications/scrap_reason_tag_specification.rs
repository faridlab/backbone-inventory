//! Specifications for ScrapReasonTag aggregate
//!
...
// Each predicate implements `Specification<ScrapReasonTag>` and can be combined
...
//
// pub struct ActiveScrapReasonTagSpec;
// impl Specification<ScrapReasonTag> for ActiveScrapReasonTagSpec {
//     fn is_satisfied_by(&self, e: &ScrapReasonTag) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
