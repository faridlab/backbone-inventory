//! Specifications for StockEntryItem aggregate
//!
...
// Each predicate implements `Specification<StockEntryItem>` and can be combined
...
//
// pub struct ActiveStockEntryItemSpec;
// impl Specification<StockEntryItem> for ActiveStockEntryItemSpec {
//     fn is_satisfied_by(&self, e: &StockEntryItem) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
