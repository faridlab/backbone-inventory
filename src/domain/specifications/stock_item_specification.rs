//! Specifications for StockItem aggregate
//!
...
// Each predicate implements `Specification<StockItem>` and can be combined
...
//
// pub struct ActiveStockItemSpec;
// impl Specification<StockItem> for ActiveStockItemSpec {
//     fn is_satisfied_by(&self, e: &StockItem) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
