//! Specifications for StockEntry aggregate
//!
...
// Each predicate implements `Specification<StockEntry>` and can be combined
...
//
// pub struct ActiveStockEntrySpec;
// impl Specification<StockEntry> for ActiveStockEntrySpec {
//     fn is_satisfied_by(&self, e: &StockEntry) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
