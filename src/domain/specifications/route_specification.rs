//! Specifications for Route aggregate
//!
...
// Each predicate implements `Specification<Route>` and can be combined
...
//
// pub struct ActiveRouteSpec;
// impl Specification<Route> for ActiveRouteSpec {
//     fn is_satisfied_by(&self, e: &Route) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
