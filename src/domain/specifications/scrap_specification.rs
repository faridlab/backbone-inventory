//! Specifications for Scrap aggregate
//!
...
// Each predicate implements `Specification<Scrap>` and can be combined
...
//
// pub struct ActiveScrapSpec;
// impl Specification<Scrap> for ActiveScrapSpec {
//     fn is_satisfied_by(&self, e: &Scrap) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
