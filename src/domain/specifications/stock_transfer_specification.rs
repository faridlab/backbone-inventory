//! Specifications for StockTransfer aggregate
//!
...
// Each predicate implements `Specification<StockTransfer>` and can be combined
...
//
// pub struct ActiveStockTransferSpec;
// impl Specification<StockTransfer> for ActiveStockTransferSpec {
//     fn is_satisfied_by(&self, e: &StockTransfer) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
