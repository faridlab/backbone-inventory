//! Specifications for StockMoveLine aggregate
//!
...
// Each predicate implements `Specification<StockMoveLine>` and can be combined
...
//
// pub struct ActiveStockMoveLineSpec;
// impl Specification<StockMoveLine> for ActiveStockMoveLineSpec {
//     fn is_satisfied_by(&self, e: &StockMoveLine) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
