//! Specifications for RouteRule aggregate
//!
...
// Each predicate implements `Specification<RouteRule>` and can be combined
...
//
// pub struct ActiveRouteRuleSpec;
// impl Specification<RouteRule> for ActiveRouteRuleSpec {
//     fn is_satisfied_by(&self, e: &RouteRule) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
