//! Specifications for Stock aggregate
//!
...
// Each predicate implements `Specification<Stock>` and can be combined
...
//
// pub struct ActiveStockSpec;
// impl Specification<Stock> for ActiveStockSpec {
//     fn is_satisfied_by(&self, e: &Stock) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
