//! Specifications for ReorderingRule aggregate
//!
...
// Each predicate implements `Specification<ReorderingRule>` and can be combined
...
//
// pub struct ActiveReorderingRuleSpec;
// impl Specification<ReorderingRule> for ActiveReorderingRuleSpec {
//     fn is_satisfied_by(&self, e: &ReorderingRule) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
