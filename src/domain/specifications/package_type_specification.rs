//! Specifications for PackageType aggregate
//!
...
// Each predicate implements `Specification<PackageType>` and can be combined
...
//
// pub struct ActivePackageTypeSpec;
// impl Specification<PackageType> for ActivePackageTypeSpec {
//     fn is_satisfied_by(&self, e: &PackageType) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
