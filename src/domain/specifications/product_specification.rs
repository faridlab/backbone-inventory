//! Specifications for Product aggregate
//!
...
// Each predicate implements `Specification<Product>` and can be combined
...
//
// pub struct ActiveProductSpec;
// impl Specification<Product> for ActiveProductSpec {
//     fn is_satisfied_by(&self, e: &Product) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
