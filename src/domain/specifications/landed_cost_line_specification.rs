//! Specifications for LandedCostLine aggregate
//!
...
// Each predicate implements `Specification<LandedCostLine>` and can be combined
...
//
// pub struct ActiveLandedCostLineSpec;
// impl Specification<LandedCostLine> for ActiveLandedCostLineSpec {
//     fn is_satisfied_by(&self, e: &LandedCostLine) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
