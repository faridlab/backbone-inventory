//! Specifications for StockLedgerEntry aggregate
//!
...
// Each predicate implements `Specification<StockLedgerEntry>` and can be combined
...
//
// pub struct ActiveStockLedgerEntrySpec;
// impl Specification<StockLedgerEntry> for ActiveStockLedgerEntrySpec {
//     fn is_satisfied_by(&self, e: &StockLedgerEntry) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
