//! Domain policy for InventoryCompanySetting aggregate
//!
...
/// Domain policy for InventoryCompanySetting — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<InventoryCompanySetting>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type InventoryCompanySettingDomainPolicy = PermitAllPolicy<InventoryCompanySetting>;
