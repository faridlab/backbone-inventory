//! Domain policy for StorageCategory aggregate
//!
...
/// Domain policy for StorageCategory — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<StorageCategory>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type StorageCategoryDomainPolicy = PermitAllPolicy<StorageCategory>;
