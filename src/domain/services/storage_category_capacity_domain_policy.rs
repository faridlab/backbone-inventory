//! Domain policy for StorageCategoryCapacity aggregate
//!
...
/// Domain policy for StorageCategoryCapacity — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<StorageCategoryCapacity>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type StorageCategoryCapacityDomainPolicy = PermitAllPolicy<StorageCategoryCapacity>;
