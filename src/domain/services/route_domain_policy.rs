//! Domain policy for Route aggregate
//!
...
/// Domain policy for Route — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<Route>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type RouteDomainPolicy = PermitAllPolicy<Route>;
