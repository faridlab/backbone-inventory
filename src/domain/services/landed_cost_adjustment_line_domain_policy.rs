//! Domain policy for LandedCostAdjustmentLine aggregate
//!
...
/// Domain policy for LandedCostAdjustmentLine — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<LandedCostAdjustmentLine>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type LandedCostAdjustmentLineDomainPolicy = PermitAllPolicy<LandedCostAdjustmentLine>;
