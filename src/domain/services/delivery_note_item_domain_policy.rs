//! Domain policy for DeliveryNoteItem aggregate
//!
...
/// Domain policy for DeliveryNoteItem — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<DeliveryNoteItem>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type DeliveryNoteItemDomainPolicy = PermitAllPolicy<DeliveryNoteItem>;
