//! Domain policy for Location aggregate
//!
...
/// Domain policy for Location — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<Location>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type LocationDomainPolicy = PermitAllPolicy<Location>;
