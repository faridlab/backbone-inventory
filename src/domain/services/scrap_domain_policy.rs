//! Domain policy for Scrap aggregate
//!
...
/// Domain policy for Scrap — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<Scrap>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type ScrapDomainPolicy = PermitAllPolicy<Scrap>;
