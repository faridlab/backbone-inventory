//! Domain policy for Bin aggregate
//!
...
/// Domain policy for Bin — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<Bin>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type BinDomainPolicy = PermitAllPolicy<Bin>;
