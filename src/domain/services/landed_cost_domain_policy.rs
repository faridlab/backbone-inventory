//! Domain policy for LandedCost aggregate
//!
...
/// Domain policy for LandedCost — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<LandedCost>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type LandedCostDomainPolicy = PermitAllPolicy<LandedCost>;
