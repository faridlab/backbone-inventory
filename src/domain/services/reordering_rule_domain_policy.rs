//! Domain policy for ReorderingRule aggregate
//!
...
/// Domain policy for ReorderingRule — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<ReorderingRule>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type ReorderingRuleDomainPolicy = PermitAllPolicy<ReorderingRule>;
