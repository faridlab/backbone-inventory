...
use backbone_inventory::seeders::SeedOperationTypeSeeder;
use backbone_inventory::seeders::SeedTransferSeeder;
use backbone_inventory::seeders::SeedRouteSeeder;
use backbone_inventory::seeders::SeedRouteRuleSeeder;
use backbone_inventory::seeders::SeedReorderingRuleSeeder;
...
async fn main() -> Result<()> {
    ...
    seeders.push(Box::new(SeedOperationTypeSeeder::new()));
    seeders.push(Box::new(SeedTransferSeeder::new()));
    seeders.push(Box::new(SeedRouteSeeder::new()));
    seeders.push(Box::new(SeedRouteRuleSeeder::new()));
    seeders.push(Box::new(SeedReorderingRuleSeeder::new()));
