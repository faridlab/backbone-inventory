//! StockEntry API Integration Tests
//!
//! Generated by metaphor-schema. Do not edit manually.
//!
//! Tests the StockEntry CRUD API endpoints.
...
// ============================================================================
// STOCKENTRY TEST DATA GENERATOR
// ============================================================================

/// Test data generator for StockEntry
pub struct StockEntryTestData;

impl TestDataGenerator for StockEntryTestData {
...
/// StockEntry API test suite
pub struct StockEntryApiTest {
    inner: GenericCrudTest<StockEntryTestData>,
}

impl StockEntryApiTest {
    pub fn new() -> Self {
        let mut config = CrudTestConfig::new("/api/v1/stock_entries", "StockEntry");
        config.supports_soft_delete = true;
        Self {
            inner: GenericCrudTest::new(config, StockEntryTestData),
        }
    }
...
impl Default for StockEntryApiTest {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    #[tokio::test]
    async fn test_stock_entry_crud() {
...
// <<< CUSTOM TESTS START >>>
// Add StockEntry specific tests here
// <<< CUSTOM TESTS END >>>
