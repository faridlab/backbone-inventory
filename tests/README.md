...
Integration test framework for the inventory bounded context module.
...
cargo test --package backbone-inventory --test run_integration_tests -- --ignored --nocapture

# 3. Run specific test suites
cargo test --package backbone-inventory --test run_integration_tests run_{{entity_name}}_api_tests -- --ignored --nocapture
```
...
backbone test generate inventory
```
...
cargo test --package backbone-inventory --test integration_tests

# Run with verbose output
TEST_VERBOSE=1 cargo test --package backbone-inventory --test run_integration_tests -- --ignored --nocapture
```
